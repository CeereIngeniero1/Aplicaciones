...
async function AreaEspecial(browser) {
    ...
    try {
        ...
        if (Agente == 1) {
            ...
            await page.type('#submitterPersonOrganizationNameId', '73002');
    ...
    await page.type('#selectedApplicantInputId', '73002');
    ...
    while (true) {
        ...
        if (band == 1) {
            ...
            await page.evaluate(() => {
                ...
                eastingInput.value = '-75,96025'; // Usar el valor con punto decimal
            ...
            await page.evaluate(() => {
                ...
                northingInput2.value = '6,11849';
                northingInput2.dispatchEvent(new Event('input', { bubbles: true }));
            });
            MonitorearAreas("AreaDePrueba", ["18N02M16N08J"]);
        }
