...
function Mineria(browser, Pin) {
    (async () => {
        ...
        while (Band != 99) {
            ...
            if (Band == 1) {
                ...
                MonitorearAreas(
                    ...
                    1,
                    "18N05E05A11G",
                    ['18N05E05A11G, 18N05E05A11L, 18N05E05A11R'],
                    2
                );
            }
        ...
        console.log('================================================================');
        let Contador_es = [
            { tipo: "Contador", nombres: ["GIOVANNY RUA VASQUEZ (83037)"] },
        ];
        ...
        await page.evaluate(() => {
            ...
            document.getElementById('activoCorrienteId0').value = '1';
            ...
            document.getElementById('pasivoCorrienteId0').value = '1';
            ...
            document.getElementById('activoTotalId0').value = '1';
            ...
            document.getElementById('pasivoTotalId0').value = '1';
        ...
        try {
            ...
            if (IdArea == "Area19") {
                ArchivoAmbiental = `C:\\Aplicaciones\\Documentos\\${Empresa}\\CertificadoAmbiental\\Certificado_Ambiental_Pol4.pdf`;

            } else if (IdArea == "Area20") {
                ArchivoAmbiental = `C:\\Aplicaciones\\Documentos\\${Empresa}\\CertificadoAmbiental\\Certificado_Ambiental_Pol5.pdf`;
        ...
        try {
            ...
            if (recaptchaFrame) {
                const recaptchaCheckbox = await recaptchaFrame.$('div.recaptcha-checkbox-border');
                if (recaptchaCheckbox) {
                    await recaptchaCheckbox.click();
                } else {
                    console.error("No se encontró el checkbox de reCAPTCHA.");
                }
            } else {
                console.error("No se encontró el iframe de reCAPTCHA.");
            }
