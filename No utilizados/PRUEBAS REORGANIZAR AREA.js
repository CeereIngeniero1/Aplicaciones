...
// const { keyboard, mouse, Key, clipboard } = require('@nut-tree/nut-js'); // PARA ESCRITURA POR TECLADO
const { keyboard, mouse, Key, clipboard } = require('@nut-tree-fork/nut-js');  //https://www.npmjs.com/package/@nut-tree-fork/nut-js?activeTab=code
...
function Mineria(browser, Pin) {
    (async () => {
        ...
        if (Agente == 1) {
            ...
            // await page.type('#submitterPersonOrganizationNameId', '74025'); // PARA PROVENZA
            await page.type('#submitterPersonOrganizationNameId', '76966'); // PARA COLLECTIVE
        ...
        while (Band != 99) {
            ...
            if (Band == 1) {
                MonitorearAreas(
                    ...
                    1,
                    "Esto es una celda de prueba",
                    ["18N05N14M12S, 18N05N14M12T, 18N05N14M12R"], 
        ...
        // // const HacerClicEnSpanDocumentacionDeSoporte = await page.$x('//span[contains(text(), "Decumentación de soporte")]');
        // // await HacerClicEnSpanDocumentacionDeSoporte.click();

        // const HacerClicEnSpanDocumentacionDeSoporte = await page.$x('//a[contains(.,"Documentac")]');
        // // await page.waitForSelector(HacerClicEnSpanDocumentacionDeSoporte);
        ...
        // const PresionarTeclaTab = await keyboard.pressKey(Key.Tab);
        // if (PresionarTeclaTab) {
        //     console.log("SE PRESIONÓ LA TECLA TAB...");
        //     const PresionarTeclaEnter =  await keyboard.pressKey(Key.Enter);
        //     if (PresionarTeclaEnter) {
...
function Correo(Tipo, Area, Celda) {
    ...
    var mailOptions = {
        ...
        to: 'soporte.ceere06068@gmail.com',
