...
async function AreaEspecial(browser) {
    ...
    try {
        ...
        if (Agente == 1) {
            ...
            await page.type('#submitterPersonOrganizationNameId', '98779');
    ...
    await page.type('#selectedApplicantInputId', '98779');
    ...
    while (true) {
        ...
        if (band == 1) {
            ...
            await page.evaluate(() => {
                ...
                eastingInput.value = '-75,48453'; // Usar el valor con punto decimal
