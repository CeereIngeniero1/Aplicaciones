...
async function AreaEspecial(browser) {
    ...
    try {
        ...
        if (Agente == 1) {
            ...
            await page.type('#submitterPersonOrganizationNameId', '83401');
    ...
    await page.type('#selectedApplicantInputId', '83401');
    ...
    while (true) {
        ...
        if (band == 1) {
            ...
            await page.evaluate(() => {
                ...
                eastingInput.value = '-72,90835'; // Usar el valor con punto decimal
            ...
            await page.evaluate(() => {
                ...
                northingInput2.value = '10,55453';
                northingInput2.dispatchEvent(new Event('input', { bubbles: true }));
            });
            MonitorearAreas("AreaDePrueba", ["18P09K21H24B"]);
        }
