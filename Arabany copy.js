...
function Mineria(browser, Pin) {
    (async () => {
        ...
        const lblRadicar = await page.$x('//a[contains(.,"Radicar solicitud de contrato de concesión diferencial")]');
        ...
        page.evaluate(() => {
            ...
            let Minerales = [ 'ANTIMONIO', 'antimonio', 'COBRE', 'cobre', 'MOLIBDENO', 'molibdeno', 'NIQUEL', 'niquel', 'ORO', 'oro', 'PLATA', 'plata', 'PLATINO', 'platino', 'WOLFRAMIO', 'wolframio', 'ZINC', 'zinc'];
        ...
        while (Band != 99) {
            ...
            if (Band == 1) {
                MonitorearAreas(
                    ...
                    1,
                    "18N02N08J04L",
                    ["18N05E03L07N, 18N05E03L12E, 18N05E03L07J, 18N05E03L13F, 18N05E03L03V, 18N05E03L13G, 18N05E03L08G, 18N05E03L08M, 18N05E03L08H, 18N05E03L07P, 18N05E03L08A, 18N05E03L13C, 18N05E03L08X, 18N05E03L08C, 18N05E03L03P, 18N05E03L07E, 18N05E03L02Z, 18N05E03L02U, 18N05E03L08F, 18N05E03L03Q, 18N05E03L08R, 18N05E03L08L, 18N05E03L04K, 18N05E03L04L, 18N05E03L04P, 18N05E03L05L, 18N05E03L12J, 18N05E03L08Q, 18N05E03L03R, 18N05E03L04M, 18N05E03L05Q, 18N05E03L07I, 18N05E03L07U, 18N05E03L08V, 18N05E03L03X, 18N05E03L03T, 18N05E03L03N, 18N05E03L04U, 18N05E03L12D, 18N05E03L13A, 18N05E03L13B, 18N05E03L08W, 18N05E03L08B, 18N05E03L08S, 18N05E03L13D, 18N05E03L03U, 18N05E03L04Y, 18N05E03L04N, 18N05E03L04Z, 18N05E03L05K, 18N05E03L07T, 18N05E03L08K, 18N05E03L03W, 18N05E03L04T, 18N05E03L12I, 18N05E03L07Y, 18N05E03L07Z, 18N05E03L03S, 18N05E03L05V"],
                    0
                );
            }
           

            await page.waitForSelector('#earlyExploitationIndNoId', { visible: true });
            await page.click('#earlyExploitationIndNoId');
        ...
        while (bandera != 99) {
            ...
            console.log(page.url());
            if (page.url() == 'https://annamineria.anm.gov.co/sigm/index.html#/p_PccdSacdInputTechnicalAndEconomicalDetails') {
                bandera = 99;
        ...
        await page.click('#techCheckboxId');
        ...
        await page.select('#personClassificationId0', 'CRNP');
        ...
        await page.evaluate(() => {
            ...
            document.getElementById('currentAssetId0').value = '3620854';
            ...
            document.getElementById('currentLiabilitiesId0').value = '758771';
            ...
            document.getElementById('totalAssetId0').value = '7109986';
            ...
            document.getElementById('totalLiabilitiesId0').value = '758771';
        ...
        await page.waitForSelector(`#p_PccdXacd1MandatoryDocumentToAttachId0`);
        const RutaDelArchivoo = `C:\\Aplicaciones\\Documentos\\${Empresa}\\Sheips\\${IdArea}.zip`;
        const ElementoControladorDeCargaaa = await page.$(`#p_PccdXacd1MandatoryDocumentToAttachId0`);
        ...
        try {
            ...
            await page.waitForSelector(`#p_PccdXacd1MandatoryDocumentToAttachId1`);
            const RutaDelArchivoo = ArchivoAmbiental;
            const ElementoControladorDeCargaaa = await page.$(`#p_PccdXacd1MandatoryDocumentToAttachId1`);
            await ElementoControladorDeCargaaa.uploadFile(RutaDelArchivoo);
