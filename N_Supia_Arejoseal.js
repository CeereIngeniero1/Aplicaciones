    ...
    while (true) {
        ...
        if (band == 1) {
            ...
            await page.evaluate(() => {
                ...
                eastingInput.value = '-75,6637'; // Usar el valor con punto decimal
            ...
            await page.evaluate(() => {
                ...
                northingInput2.value = '5,51062';
                northingInput2.dispatchEvent(new Event('input', { bubbles: true }));
            });
            MonitorearAreas("AreaDePrueba", ["18N05A24N13W"]);
        }
