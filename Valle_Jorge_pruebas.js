...
// Actualizado
var Empresa = 'Valleduper';
var user1 = '75967';
var pass1 = 'Sierraazulv2024*';
var user2 = '83949';
var pass2 = '*Jcrmh2022#';
var Agente = 1;
...
function Mineria(browser,  Pin) {
    (async () => {
        ...
        if (Agente == 1) {
            ...
            await page.type('#submitterPersonOrganizationNameId', '75967');
        ...
        while (Band != 99) {
            ...
            if (Band == 1) {
                MonitorearAreas(
                    ...
                    1,
                    "18P09K04N18H",
                    ['18N05A15N04R, 18N05A15N04S, 18N05A15N04M, 18N05A15J24X, 18N05A15J24S, 18N05A15N04N, 18N05A15J24Y, 18N05A15J24T, 18N05A15N04Z, 18N05A15N05R, 18N05A15N05D, 18N05A15N04W, 18N05A15N04X, 18N05A15N04H, 18N05A15N04Y, 18N05A15N04U, 18N05A15J25W, 18N05A15N05H, 18N05A15J25S, 18N05A15N05N, 18N05A15J25T, 18N05A15N04G, 18N05A15N04P, 18N05A15J24Z, 18N05A15N05W, 18N05A15N05G, 18N05A15N05B, 18N05A15J25Q, 18N05A15N05X, 18N05A15N05M, 18N05A15J25X, 18N05A15J24R, 18N05A15N04J, 18N05A15N04E, 18N05A15J25R, 18N05A15N05S, 18N05A15N05Y, 18N05A15N05T, 18N05A15J25Y, 18N05A15N04T, 18N05A15N05F, 18N05A15N04L, 18N05A15N04B, 18N05A15N04C, 18N05A15J24U, 18N05A15N05V, 18N05A15N05A, 18N05A15N05I, 18N05A15J24W, 18N05A15N04I, 18N05A15N04D, 18N05A15N05Q, 18N05A15N05K, 18N05A15N05L, 18N05A15J25V, 18N05A15N05C'], // DON JORGE ACA COLOCAS EL AREA QUE TERMINA EN 90
                    77
                );
            }
            if (Band == 81) {
        ...
        console.log('================================================================');
        let Contador_es = [
            { tipo: "Contador", nombres: ["PATRICIA IVONNY PATIÑO ACUÑA (71237)"] },
        ];
        ...
        await page.evaluate(() => {
            ...
            document.getElementById('activoCorrienteId0').value = '331351836';
            ...
            document.getElementById('pasivoCorrienteId0').value = '828485386';
            ...
            document.getElementById('activoTotalId0').value = '17248660575';
            ...
            document.getElementById('pasivoTotalId0').value = '2084940136';
