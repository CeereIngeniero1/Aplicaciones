...
async function Pagina() {
    //Recordar colocar en Pin.txt el pin a utilizar y la iniciales correspondientes
...
function Mineria(browser,  Pin) {
    (async () => {
        ...
        //Solo en el caso que es agente se debe verificar el Numero de Empresa a la cual se es agente
        if (Agente == 1) {
            ...
            await page.type('#submitterPersonOrganizationNameId', user1);
        ...
        while (Band != 99) {
           ...
           for (let i = 0; i < FechaReapertura.length; i++) {
            ...
            if (cont == "0") {
                ...
                Band++;
                //En este sector se coloca la cantidad de areas + 1
                if (Band == 2) {
                    Band = 1;
                }
