...
function Mineria(browser,  Pin) {
    (async () => {
        ...
        while (Band != 99) {
            ...
            if (Band == 1) {
                MonitorearAreas(
                    ...
                    1,
                    "",
                    ["18N05A24K11Q, 18N05A24K11V, 18N05A24J15P, 18N05A24J15U, 18N05A24J15Z, 18N05A24K11K, 18N05A24J15J"],
                    0
                );
            }
            if (Band == 81) {
        ...
        try {
            ...
            }else if(IdArea == '501711'  ){
                ArchivoAmbiental = `C:\\Aplicaciones\\Documentos\\${Empresa}\\CertificadoAmbiental\\501711.pdf`;
