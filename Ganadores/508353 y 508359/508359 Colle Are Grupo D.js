...
async function AreaEspecial(browser) {
    ...
    try {
        ...
        if (Agente == 1) {
            ...
            await page.type('#submitterPersonOrganizationNameId', '98819');
    ...
    await page.type('#selectedApplicantInputId', '98819');
    ...
    while (true) {
        ...
        if (band == 1) {
            ...
            await page.evaluate(() => {
                ...
                eastingInput.value = '-75,53062'; // Usar el valor con punto decimal
            ...
            await page.evaluate(() => {
                ...
                northingInput2.value = '5,60036';
                northingInput2.dispatchEvent(new Event('input', { bubbles: true }));
            });
            MonitorearAreas("AreaDePrueba", ["18N05A20P24Z, 18N05A20P25W, 18N05A20P25V, 18N05A20P25X"]);
        }
