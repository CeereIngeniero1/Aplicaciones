    ...
    (async () => {
        ...
        try {
            ...
            if(IdArea == '510535PARTE A'){
                 ArchivoAmbiental = `C:\\Aplicaciones\\Documentos\\${Empresa}\\CertificadoAmbiental\\510535PARTE A.pdf`;
            }else if(IdArea == '510535PARTE B'){
                 ArchivoAmbiental = `C:\\Aplicaciones\\Documentos\\${Empresa}\\CertificadoAmbiental\\510535PARTE B.pdf`;
